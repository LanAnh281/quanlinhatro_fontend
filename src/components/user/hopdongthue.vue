<template>
  <div class="col-12">
    ...
    <div class=" border mt-5 px-5">
      <div class=" text-center mt-5 mx-5 p-5">
      ...
      <div>
        <i
          >Căn cứ luật Dân sự 33/2005/QH11, Luạt Nhà ở số 56/2005/QH11 và các
          văn bản hướng dẫn thi hành;</i
        >
        <br />
        <i>Căn cứ khả năng và nhua cầu của hai bên bên trong hợp đồng nay:</i>
        <br />
        <p class="mt-1">
          Hôm nay, ngày {{ hopdong.ngaylap }}. Chúng tôi bao gồm:
        </p>
        <p>Bên cho thuê(Bên A): {{ nhatro.hoten }}</p>
        <p>Số CMND: {{ nhatro.cccd }}</p>
        <p>Số điện thoại:{{ nhatro.sdt }}</p>
        <p>
          {{ nhatro.hoten }} là chủ sở hữu nhà ở và quyền sử dụng đất tại địa
          chỉ {{ nhatro.diachi }}.
        </p>
        <p>
          Hôm nay, ngày {{ hopdong.ngaylap }} tại {{ nhatro.diachi }}, Chúng tôi
          bao gồm:
        </p>
        ...
        <p>
          Bên A đồng ý cho bên B thuê và bên B đồng ý thuê
          {{ hopdong.tenphong }} thuộc loại nhà phòng {{ phong.tenloai }} thuộc
          dãy phòng trọ căn nhà số {{ nhatro.diachi }}
        </p>
        <p>
          Thời hạn hợp đồng thuê bắt đầu từ ngày: {{ hopdong.ngaybd }} kết thúc
          ngày: {{ hopdong.ngaykt }}
        </p>
        <h6>Điều 2: Tiền thuê nhà trọ</h6>
        <p>-Giá tiền thuê nhà : {{ phong.giaphong }} ngàn đồng</p>
        <p>
          Tiền thuê nhà bên B thanh toán cho bên A từ ngày 6 tây đầu mỗi tháng
        </p>
